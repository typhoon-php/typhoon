...
final class StringifyTypeVisitorTest extends TestCase
{
    ...
    public static function typesAndTheirStringRepresentations(): \Generator
    {
        ...
        yield [types::intMask(types::union(types::literal(1), types::literal(2), types::literal(4))), 'int-mask-of<1|2|4>'];
        ...
        yield [types::literal(0.234), '0.234'];
        yield [types::literal(-0.234), '-0.234'];
        ...
        yield [types::literal('abcd'), "'abcd'"];
        yield [types::literal("a'bcd"), "'a\\'bcd'"];
        yield [types::literal("a\\\\'bcd"), "'a\\\\\\\\\\'bcd'"];
        yield [types::literal("\n"), "'\\n'"];
