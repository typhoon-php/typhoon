...
{
    #[DataProviderExternal(TypeProvider::class, 'nativeTypes')]
    ...
    #[DataProviderExternal(TypeProvider::class, 'nativeTypes')]
    #[DataProviderExternal(TypeProvider::class, 'callableType')]
    ...
    #[DataProviderExternal(TypeProvider::class, 'nativeTypes')]
    #[DataProviderExternal(TypeProvider::class, 'staticType')]
    #[DataProviderExternal(TypeProvider::class, 'callableType')]
    #[DataProviderExternal(TypeProvider::class, 'voidType')]
    #[DataProviderExternal(TypeProvider::class, 'neverType')]
