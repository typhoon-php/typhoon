...
final class GlobalScopeTest extends TestCase
{
    ...
    public function testItDoesNotResolveSelf(): void
    {
        ...
        $this->expectExceptionObject(new \LogicException('Cannot resolve self in global scope.'));
    ...
    public function testItDoesNotResolveParent(): void
    {
        ...
        $this->expectExceptionObject(new \LogicException('Cannot resolve parent in global scope.'));
